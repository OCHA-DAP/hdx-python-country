...
class TestCountry:
    ...
    def test_get_country_info_from_iso3(self):
        assert Country.get_country_info_from_iso3("bih") == {'Admin Level': '0',
 ...
 'x Alpha2 codes': None,
 'x Alpha3 codes': None}
        assert Country.get_country_info_from_iso3("PSE") == {'Admin Level': '0',
 ...
 'x Alpha3 codes': None}
        ...
        self.setup_unofficial_date()
        assert Country.get_country_info_from_iso3("AZO") == {'Admin Level': None,
 'Appears in DGACM list': None,
 ...
 'x Alpha3 codes': 'AZO'}
    ...
    def test_get_country_info_from_iso2(self):
        assert Country.get_country_info_from_iso2("jp") == {'Admin Level': '0',
 'Appears in DGACM list': 'Y',
 'Appears in UNTERM list': 'Y',
 ...
 'x Alpha3 codes': None}
        ...
        assert Country.get_country_info_from_iso2("TW") == {'Admin Level': '0',
 'Appears in DGACM list': None,
 'Appears in UNTERM list': None,
 'Arabic Short': None,
 'Chinese Short': None,
 ...
 'x Alpha3 codes': None}
        ...
        assert Country.get_country_info_from_iso2("PS") == {'Admin Level': '0',
 'Appears in DGACM list': None,
 'Appears in UNTERM list': 'Y',
 'Arabic Short': 'دولة فلسطين',
 'Chinese Short': '巴勒斯坦国',
 ...
 'x Alpha3 codes': None}
        ...
        self.setup_unofficial_date()
        assert Country.get_country_info_from_iso2("XK") == {'Admin Level': None,
 'Appears in DGACM list': None,
 'Appears in UNTERM list': None,
 'Arabic Short': None,
 'Chinese Short': None,
 ...
 'x Alpha3 codes': 'XKX'}
    ...
    def test_get_country_info_from_m49(self):
        assert Country.get_country_info_from_m49(4) == {'Admin Level': '0',
 'Appears in DGACM list': 'Y',
 'Appears in UNTERM list': 'Y',
 ...
 'x Alpha2 codes': None,
 'x Alpha3 codes': None}
        assert Country.get_country_info_from_m49(882) == {'Admin Level': '0',
 'Appears in DGACM list': 'Y',
 'Appears in UNTERM list': 'Y',
 'Arabic Short': 'ساموا',
 'Chinese Short': '萨摩亚',
 ...
 'x Alpha2 codes': None,
 'x Alpha3 codes': None}
        assert Country.get_country_info_from_m49(275) == {'Admin Level': '0',
 'Appears in DGACM list': None,
 'Appears in UNTERM list': 'Y',
 'Arabic Short': 'دولة فلسطين',
 'Chinese Short': '巴勒斯坦国',
 ...
 'x Alpha3 codes': None}
    ...
    def test_ocha_feed_file_working(self):
        with Download(user_agent="test") as downloader:
            _, countries = downloader.get_tabular_rows(script_dir_plus_file("Countries_UZB_Deleted.csv", TestCountry), dict_form=True)
